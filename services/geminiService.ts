...
// Fix: Per coding guidelines, initialize GoogleGenAI by passing the API key directly from process.env.
...
export const generateWebsiteContent = async (cvText: string): Promise<{ profile: Profile }> => {
    try {
